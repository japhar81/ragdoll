...
// Provider-registry + embed-texts helpers live next door so sibling
// plugin modules (./plugins/opensearch.ts will land in a follow-up
// split) can reuse the same wiring.
