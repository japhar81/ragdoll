...
| conversation_rewrite | transformer | [conversation_rewrite.md](conversation_rewrite.md) |
| dataset_search | retriever | [dataset_search.md](dataset_search.md) |
| dataset_upsert | sink | [dataset_upsert.md](dataset_upsert.md) |
...
| merge_rrf | transformer | [merge_rrf.md](merge_rrf.md) |
...
| action_status_refresh | transformer | [action_status_refresh.md](action_status_refresh.md) |
| chunk_contextual | chunker | [chunk_contextual.md](chunk_contextual.md) |
| compose_with_style | llm | [compose_with_style.md](compose_with_style.md) |
| email_preprocess | transformer | [email_preprocess.md](email_preprocess.md) |
| entity_resolve | transformer | [entity_resolve.md](entity_resolve.md) |
| extract_entities | transformer | [extract_entities.md](extract_entities.md) |
...
| query_classify | transformer | [query_classify.md](query_classify.md) |
| summarize_event | transformer | [summarize_event.md](summarize_event.md) |
| thread_aggregate | transformer | [thread_aggregate.md](thread_aggregate.md) |
| tone_profile_build | transformer | [tone_profile_build.md](tone_profile_build.md) |
...
| query_fanout | transformer | [query_fanout.md](query_fanout.md) |
| query_hyde | transformer | [query_hyde.md](query_hyde.md) |
| rerank_bge | reranker | [rerank_bge.md](rerank_bge.md) |
| rerank_llm | reranker | [rerank_llm.md](rerank_llm.md) |
...
| topic_shift_detect | router | [topic_shift_detect.md](topic_shift_detect.md) |
